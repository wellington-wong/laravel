...
Route::get('/company/login', 'CompanyController@login')->name('company-login');
Route::get('/company/registration', 'CompanyController@registration')->name('company-registration');
