...
Route::post('/company/delete/{id}', ['uses' => 'CompanyController@postDeleteCompany', 'middleware' => ['role:globalAdmin']])->name('company-delete');
Route::get('/company/delete/{id}', ['uses' => 'CompanyController@postDeleteCompany', 'middleware' => ['role:globalAdmin']])->name('company-delete');
...
Route::group(['prefix' => '/', 'middleware' => ['role:admin|superAdmin|globalAdmin']], function() {
	...
	Route::get('/global-settings/edit-basic-pages/', ['uses' => 'GlobalSettingsController@editBasicPages', 'middleware' => ['role:globalAdmin']])->name('edit-basic-pages');
	Route::get('/program-options/edit-member-pages/', ['uses' => 'ProgramOptionsController@editMemberPages', 'middleware' => ['role:admin|superAdmin|globalAdmin']])->name('edit-member-pages');
	Route::get('/global-settings/edit-member-page/{id}', ['uses' => 'ProgramOptionsController@editMemberPage', 'middleware' => ['role:admin|superAdmin|globalAdmin']])->name('edit-member-page');
	...
	Route::get('/members/export', 'MembersController@exportMembers')->name('export-members');
	Route::get('/members/export/fields', 'MembersController@exportMembersFields')->name('export-members-fields');
...
// Reviews Version 2
Route::get('/user-reviews', 'ReviewsController@userReviews')->name('user-reviews');
Route::get('/user-review/create', 'ReviewsController@submit')->name('user-create-review');
Route::post('/user-review/create', 'ReviewsController@postSubmit')->name('user-submit-review');
