            ...
            <nav>
                ...
                <div class="panel panel-default fill">
                    <div class="panel-heading"><a class="logo" style="background: url('/{{ isset($_company->logo) ? $_company->logo : 'images/logo.png' }}') center no-repeat" href="{!! url('/') !!}"></a></div>
                            ...
                            <ul class="nav" >
                                <li class="">
                                    ...
                                    <ul id="global-settings" class="collapse in">
                                        ...
                                        @can('edit-basic-pages') @if ($_company->id)<li class="{{ Request::is('global-settings/edit-basic-pages') ? 'active' : '' }}"><a href="{{ route('edit-basic-pages') }}">Edit Basic Pages</a></li>@endif @endcan                                       
