            ...
            <div class="row">
                <div class="col-md-12 table-referral-wrapper table-wrapper {{ auth()->user()->hasRole('member') ? 'member-referrals' : '' }}">
                    ...
                    <div class="col-md-6 filter-item date-range analytics-calendar">
                        ...
                        {{ Form::text('daterange_analytics', app('request')->get('date') ?: date('F') . ' ' . date('Y'), ['class' => 'form-control text', 'data-query' => (isset($param->daterange) ? $param->daterange : ''), 'data-url' => route('get-program-options-analytics')] ) }}            
