        ...
        <div class="row">
            <div class="col-md-4 referral-hub">
                <div class="pending-approval">
                    <div class="rh-count"><span>{{ isset($pendingReferrals['approval']) ? count($pendingReferrals['approval']) : 0 }}</span></div><hr />                
                    <div class="rh-desc">
            ...
            <div class="col-md-4 referral-hub">
                <div class="pending-reward">
                    <div class="rh-count"><span>{{ isset($pendingReferrals['reward']) ? count($pendingReferrals['reward']) : 0 }}</span></div><hr />                
                    <div class="rh-desc">
