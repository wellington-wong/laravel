	                              ...
	                              <tr>
	                                 <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
	                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">If you’re having trouble clicking the "Go To User" button, copy and paste the URL below
	                                       into your web browser: <a href="{ { perxi_home }}/user-reviews" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;"></a><a href="{ { perxi_home }}/user-reviews" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">{ { perxi_home }}/user-reviews</a>
	                                    </p>
	                                 </td>
	                              </tr>
	                           </table>
